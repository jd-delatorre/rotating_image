/**
 * Created by jdelatorre312 on 9/12/15.
 */
...
var $listItems = $('#rm_container > ul > li'),
    ...
    //the masks and corners of the sliders
...
//check if the browser is <= IE8
    ...
    RotateImageMenu = (function(){
        ...
        var timeDiff = 300,
            ...
            /*
            * all our images are 310 width and 465 height, this could/should be dynamically
            * calculated if we had different size images.
            *
            * we will set the rotational origin at x = width/2 and y = height*2
            *
            * */
            ...
            initEventsHandler = function(){
                ...
                * we will stop slideshow if active
                * and rotate each image
                *
                * 1 for rotate right
                * -1 for rotate left
                *
                * */
                ...
                //add events to mouse and left and right keys
            ...
            //rotates each item's images

            rotateImages = function(dir){
                //if animation is in progress return
                ...
                $listItems.each(function(i){
                    ...
                    * if rotation is to the right, then the first item to rotate is the first one
